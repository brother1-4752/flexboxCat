...
const boardSecond = document.querySelector(".board__second");
const nextBtn = document.querySelector(".next-btn");
const resetBtn = document.querySelector("#reset");

// boardFirst.innerHTML
// boardSecond.outerHTML

const playDocs = {
  1: [
    `        <div id="house">
    <div class="kitty">
      <img class="cats" src="images/darkblack-cat.svg" alt="블랙고양이" />
    </div>
  </div>`,
    `
      <div id="background">
    <div class="bowl">
      <img class="cats" src="images/darkblack-bowl.png" alt="블랙그릇" />
    </div>
  </div>`,
    "flex-end",
  ],
  ...
  <div id="house">
    <div class="kitty">
      <img class="cats" src="images/white-cat.svg" alt="흰고양이" />
    </div>
  </div>`,
    `
      <div id="background">
  ...
  <div id="background">
    <div class="bowl">
      <img class="cats" src="images/white-bowl.png" alt="흰그릇" />
    </div>
  </div>`,
    "center",
  ],
  3: [
    ...
    <div id="house">
      <div class="kitty">
        <img class="cats" src="images/brown-cat.svg" alt="갈색고양이" />
      </div>
    </div>`,
    `
    <div id="background">
    ...
    <div id="background">
      <div class="bowl">
        <img class="cats" src="images/brown-bowl.png" alt="갈색그릇" />
      </div>
    </div>
  `,
    "space-around",
...
function updateInstructionsByMarker(t) {
  ...
  boardFirst.innerHTML = playDocs[t.dataset.level][0];
  boardSecond.innerHTML = playDocs[t.dataset.level][1];
  boardSecond.style.justifyContent = playDocs[t.dataset.level][2];
}
...
function updateInstructionsByArrowRight() {
  if (docs[parseInt(currentStage.innerHTML) + 1] != undefined) {
    ...
    boardFirst.innerHTML = playDocs[parseInt(currentStage.innerHTML)][0];
    boardSecond.innerHTML = playDocs[parseInt(currentStage.innerHTML)][1];
    boardSecond.style.justifyContent =
      playDocs[parseInt(currentStage.innerHTML)][2];
  }
}
...
function updateInstructionsByArrowLeft() {
  if (currentStage.innerHTML != "1") {
    ...
    boardFirst.innerHTML = playDocs[`${currentStage.innerHTML}`][0];
    boardSecond.innerHTML = playDocs[`${currentStage.innerHTML}`][1];
    boardSecond.style.justifyContent = playDocs[`${currentStage.innerHTML}`][2];
  }
}
...
function moveCats() {
  ...
  justifyContent.forEach((value) => {
    ...
    if (code.includes(`justify-content:${boardSecond.style.justifyContent}`)) {
